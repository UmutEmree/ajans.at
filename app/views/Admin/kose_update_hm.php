<div class="col-md-9">
       <div class="grid simple">
              ...
              <form action="<?php echo SITE_URL ?>Admin/Kose/Update_Run/<?php echo $content["yazi_id"]; ?>" method="post" class="form-horizontal row-border" id="koseyazilari" enctype="multipart/form-data">
              <?php echo $alert; ?>
...
<div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="hidden" name="oldresim" value="<?php echo $content['yazi_image']; ?>">
                  </div>
 ...
 <hr class="bir">
             ...
             <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <img id="onizle1" src="<?php echo SITE_UPLOAD_DIR ?>content/<?php echo $content['yazi_image']; ?>" width="100" <?php if(empty($content['yazi_image'])){ ?>style="display:none;" <?php } ?> />
