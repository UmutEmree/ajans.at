...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Köşe Yazarları Giriş Formu</h2>
          ...
          <br>
		   ...
		   <button class="btn btn-block btn-success col-md-8" type="button">
            ...
            <span class="bold">Telefonumu onayla</span>
		    </button>
        </div>
    ...
    <form id="login-form" class="login-form" action="<?php echo SITE_URL; ?>Admin/Yazarlogin/runLogin" method="post">
		 <div class="row">
      <?=$alert ?>
